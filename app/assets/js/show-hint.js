...
(function(mod) {
  ...
  CodeMirror.defineExtension("showHint", function(options) {
    ...
    if (this.state.completionActive) return;
  ...
  CodeMirror.defineExtension("resolveHint", function(options) {
    options = parseOptions(this, this.getCursor("start"), options);
    var selections = this.listSelections()
    if (selections.length > 1) return;
    // By default, don't allow completion when something is selected.
  ...
  CodeMirror.commands.autoresolve = CodeMirror.resolveHint;
  ...
  function autoShowComplete(cm, event) {
    if (!cm.state.completionActive && /*Enables keyboard navigation in autocomplete list*/
        event.keyCode != 13) {        /*Enter - do not open autocomplete list just after item has been selected in it*/ 
        CodeMirror.commands.autocomplete(cm, null, {completeSingle: false});
    }
  };
  CodeMirror.autoShowComplete = autoShowComplete;
});
