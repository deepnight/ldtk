...
`__pivot`<br/> ![Generic badge](https://img.shields.io/badge/Added_0.6.3-green.svg)  | Array&nbsp;of&nbsp;Float | Pivot coordinates  (`[x,y]` format) of the Entity (Float values from 0 to 1)
