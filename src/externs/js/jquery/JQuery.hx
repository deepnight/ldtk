...
@:native("$") extern class JQuery implements ArrayAccess<js.html.Element> {
	...
	**/
	static public var ready : js.lib.Promise.Thenable<Dynamic>;
	/**
		Handles errors thrown synchronously in functions wrapped in <code>jQuery()</code>.
	**/
	static public dynamic function readyException(error:js.lib.Error):String;
	/**
	...
	**/
	static public function when(deferreds:haxe.extern.EitherType<js.jquery.Promise, haxe.extern.EitherType<haxe.extern.Rest<js.jquery.Deferred>, js.lib.Promise.Thenable<Dynamic>>>):js.jquery.Promise;
	/**
