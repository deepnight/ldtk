# 0.4.0-beta
 ...
 - Added `layerInstance.autoLayerTiles` which is a more compact version of the tiles data generated by Auto-layer rules. It contains the following fields:
   - `coord: [x,y]`: an array of 2 values representing the x,y pixel coordinates of the tile in the **level**
   - `src: [x,y]`: an array of 2 values representing the x,y pixel coordinates of the tile in the **tileset**
