# LDtk Json structure (version 1.5.0)
...
`uiFilterTags`<br/><sup class="internal">*Only used by editor*</sup><br/> ![Generic badge](https://img.shields.io/badge/Added_1.4.2-gray.svg)  | Array&nbsp;of&nbsp;String | Display tags
