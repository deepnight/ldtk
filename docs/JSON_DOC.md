...
`canSelectWhenInactive`<br/><sup class="internal">*Only used by editor*</sup><br/> ![Generic badge](https://img.shields.io/badge/Added_1.1.4-green.svg)  | Bool | Allow editor selections when the layer is not currently active.
