...
`toc`<br/> ![Generic badge](https://img.shields.io/badge/Added_1.2.4-green.svg)  | Array&nbsp;of&nbsp;Object | All the instances of entities that have their `exportToToc` flag enabled are listed this array.<br/> This object contains the following fields:<br/> <ul><li>**`identifier`** **(String**)</li><li>**`instances`** **(Array of [Field instance entity reference](#ldtk-EntityReferenceInfos)**)</li></ul>
