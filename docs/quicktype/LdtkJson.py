...
class LdtkTocInstanceData:
    ...
    def __init__(self, fields: List[Any], hei_px: int, iids: ReferenceToAnEntityInstance, wid_px: int, world_x: int, world_y: int) -> None:
        self.fields = fields
        self.hei_px = hei_px
        self.iids = iids
        self.wid_px = wid_px
